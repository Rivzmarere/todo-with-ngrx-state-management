        ...
        workspace.projects.forEach((project) => {
            project.targets.forEach((target) => {
                ...
                if (target.builder === '@angular-devkit/build-angular:browser') {
                    const baseConfig = ((_a = target.options) === null || _a === void 0 ? void 0 : _a.tsConfig) ? core_1.resolve(core_1.dirname(core_1.normalize(target.options.tsConfig)), workspace_1.readJsonInTree(host, target.options.tsConfig).extends)
                        : null;
                    if (baseConfig &&
