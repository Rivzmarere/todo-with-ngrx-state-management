...
function generateFiles(options) {
    return (host, context) => {
        ...
        return schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files'), [
            schematics_1.template(Object.assign(Object.assign({ tmpl: '' }, options), { projectRoot: projectConfig.root, isLibrary: projectConfig.projectType === 'library', offsetFromRoot: workspace_1.offsetFromRoot(projectConfig.root) })),
