(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NgxRolesService = /** @class */ (function () {
        ...
        NgxRolesService.prototype.addRoleWithPermissions = function (name, permissions) {
        ...
        NgxRolesService.prototype.addRolesWithPermissions = function (rolesObj) {
            var _this = this;
            Object.keys(rolesObj).forEach(function (key, index) {
                _this.addRoleWithPermissions(key, rolesObj[key]);
            });
        };
        NgxRolesService.prototype.flushRoles = function () {
            this.rolesSource.next({});
        };
        NgxRolesService.prototype.flushRolesAndPermissions = function () {
            this.flushRoles();
